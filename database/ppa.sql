...
(67, 'BCS', '2022-12-18 22:29:44'),
(68, 'MCS', '2022-12-18 22:25:26'),
(69, '10TH CLASS', '2022-12-23 18:48:50'),
(70, 'M.SC CS', '2023-01-08 14:54:29');
...
(9, 'Dhiraj', '68', 'male', '2001-05-18', 'first year', 'dhirajphatake185@gmail.com', 'pass@123', 'active'),
(10, 'Dhiraj Phatake', '68', 'male', '2001-05-18', 'first year', 'dhiraj@gmail.com', 'dhiraj@123', 'active'),
(11, 'Dhiraj Phatake', '68', 'male', '2001-05-18', 'first year', 'dhirajphatake@gmail.com', 'pass@123', 'active'),
(12, 'Sunit', '69', 'male', '2001-08-13', 'first year', 'sunit@gmail.com', 'pass@123', 'active'),
(13, 'Akash', '70', 'male', '2000-07-06', 'first year', 'akashgat@gmail.com', 'pass@123', 'active'),
(14, 'Gaurav Bhalavi ', '70', 'male', '2000-12-09', 'first year', 'gauravbhalavi@gmail.com', 'pass@123', 'active'),
(15, 'Dhiraj D Phatke', '70', 'male', '2001-05-18', 'first year', 'dhirajdphatake@gmail.com', 'pass@123', 'active');
...
(321, 11, 25, 41, 'Dhiraj', 'new', '2022-12-19 18:34:08'),
(322, 11, 26, 42, 'Donolf Trump', 'new', '2022-12-19 19:11:51'),
(323, 10, 25, 41, 'Dhiraj', 'new', '2022-12-20 10:09:17'),
(324, 10, 26, 42, 'Messi', 'new', '2022-12-20 10:09:28'),
(325, 12, 27, 43, 'The great Khali', 'new', '2022-12-23 18:52:35'),
(326, 9, 26, 42, 'Messi', 'new', '2022-12-25 11:55:12'),
(327, 9, 25, 41, 'Dhiraj', 'new', '2022-12-25 11:55:28'),
(328, 13, 28, 44, 'Hypertext Preprocessor', 'new', '2023-01-08 15:06:19'),
(329, 13, 28, 47, '.php', 'new', '2023-01-08 15:06:19'),
(330, 13, 28, 48, '.hphp', 'new', '2023-01-08 15:06:19'),
(331, 13, 28, 45, 'Rasmus Lerdrof', 'new', '2023-01-08 15:06:19'),
(332, 13, 28, 49, 'Both (b) and (c)', 'new', '2023-01-08 15:06:19'),
(333, 14, 28, 48, '.php', 'new', '2023-01-08 15:15:25'),
(334, 14, 28, 45, 'Rasmus Lerdrof', 'new', '2023-01-08 15:15:25'),
(335, 14, 28, 49, 'Both (b) and (c)', 'new', '2023-01-08 15:15:25'),
(336, 14, 28, 44, 'Hypertext Preprocessor', 'new', '2023-01-08 15:15:25'),
(337, 14, 28, 47, '.php', 'new', '2023-01-08 15:15:25'),
(338, 15, 28, 44, 'Hypertext Preprocessor', 'new', '2023-01-08 15:22:42'),
(339, 15, 28, 48, '.php', 'new', '2023-01-08 15:22:42'),
(340, 15, 28, 45, 'Rasmus Lerdrof', 'new', '2023-01-08 15:22:42'),
(341, 15, 28, 47, '.php', 'new', '2023-01-08 15:22:42'),
(342, 15, 28, 49, 'Both (b) and (c)', 'new', '2023-01-08 15:22:42');
...
(36, 24, 'Which of the following is used to display the output in PHP?', 'echo', 'write', 'print', 'Both (a) and (c)', 'Both (a) and (c)', 'active'),
(37, 24, 'Which of the following is used for concatenation in PHP?', '+ (plus)', '* (Asterisk)', '. (dot)', 'append()', '. (dot)', 'active'),
(38, 24, 'Which of the following is the correct way to create a function in PH', 'Create myFunction()', 'New_function myFunction()', 'function myFunction()', 'None of the above', 'function myFunction()', 'active'),
(39, 24, 'Which of the following PHP function is used to generate unique id?', 'id()', 'mdid()', 'uniqueid()', 'None of the above', 'uniqueid()', 'active'),
(40, 24, 'Which of the following is the correct way of defining a variable in PHP?', '$variable name = value;', '$variable_name = value;', '$variable_name = value', '$variable name as value;', '$variable_name = value;', 'active'),
(41, 25, 'What is your name', 'Dhiraj', 'abhi', 'saurabh', 'rahul', 'Dhiraj', 'active'),
(42, 26, 'Fifa World 2022 Winner', 'Messi', 'Ronaldo', 'Sunil', 'Donolf Trump', 'Messi', 'active'),
(43, 27, 'Who is education minister?', 'Uday samant', 'Narendra modi', 'Ronaldo', 'The great Khali', 'Uday samant', 'active'),
(44, 28, 'PHP stands for -', 'Hypertext Preprocessor', 'Pretext Hypertext Preprocessor', 'Personal Home Processor', 'None of the above', 'Hypertext Preprocessor', 'active'),
(45, 28, 'Who is known as the father of PHP?', 'Drek Kolkevi', 'List Barely', 'Rasmus Lerdrof', 'None of the above', 'Rasmus Lerdrof', 'active'),
(47, 28, 'Which of the following is the default file extension of PHP?', '.php', '.hphp', '', '', '', 'active'),
(48, 28, 'Which of the following is the default file extension of PHP..?', '.php', '.hphp', '.xml', '.html', '.php', 'active'),
(49, 28, 'Which of the following is correct to add a comment in php?', '& …… &', '// ……', '/* …… */', 'Both (b) and (c)', 'Both (b) and (c)', 'active');
...
(24, 67, 'PHP Exam', '10', 5, 'Internal Exam', '2022-12-18 22:26:15'),
(25, 68, 'Ms-cit', '10', 1, 'xyz', '2022-12-19 18:34:29'),
(26, 68, 'Demo Q.', '10', 1, 'xyz', '2022-12-19 19:10:30'),
(27, 69, '10th Class', '10', 1, 'Demo test\r\n', '2022-12-23 18:49:35'),
(28, 70, 'PHP Text', '10', 5, 'php exam', '2023-01-08 14:55:49');
...
(10, 10, 'Dhiraj Phatake', 'Great Question', 'December 20, 2022'),
(11, 10, '', 'hii', 'December 20, 2022'),
(12, 10, 'Dhiraj Phatake', 'hii', 'December 20, 2022'),
(13, 9, 'Dhiraj', 'hey i have a query', 'January 08, 2023'),
(14, 13, 'Akash', 'Query...', 'January 08, 2023'),
(15, 14, 'Gaurav Bhalavi ', 'I have a query', 'January 08, 2023');
...
--
ALTER TABLE `exam_answers`
  MODIFY `exans_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=343;
