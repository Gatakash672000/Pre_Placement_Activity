   ...
   <form class="refreshFrm" id="addFeebacks" method="post">
     <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Your Query</h5>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          ...
          <div class="form-group">
           <textarea name="myFeedbacks" class="form-control" rows="3" placeholder="Enter your quere here.."></textarea>
          </div>
        </div>
      </div>
